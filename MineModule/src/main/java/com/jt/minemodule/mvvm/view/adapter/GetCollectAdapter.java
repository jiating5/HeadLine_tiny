package com.jt.minemodule.mvvm.view.adapter;
...
import com.jt.minemodule.mvvm.bean.GetCollectBean;
...
public class CollectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Context context;
    List<GetCollectBean> list;

    public CollectAdapter(Context context, List<GetCollectBean> list) {
